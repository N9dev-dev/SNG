const nickName = document.getElementById("nickname"),
    ...
    presets = {
        1: {
            colors: ["0094FF", "0094FF"],
            text: "EZ"
        },
        2: {
            colors: ["FFD707", "FF5555"],
            text: "noobed"
        },
        3: {
            colors: ["00FF57", "156A00"],
            text: "trash"
        },
        4: {
            colors: ["0075FF", "FF68F9"],
            text: "idiot"
        },
        5: {
        ...
        6: {
            colors: ["FF0000", "481818"],
            text: "KYS"
        },
        7: {
            colors: ["EBFF00", "FF00E6"],
            text: "mad?"
        },
        8: {
            colors: ["8195FF", "8F00FF"],
            text: "BROKIE"
        },
        9: {
            colors: ["FAFF13", "00FFA3"],
            text: "HaHa"
        },
        10: {
            colors: ["BD00FF", "FFD600"],
            text: "2EZ FR"
        },
        11: {
            colors: ["EE84FF", "00A42E"],
            text: "git gud"
        },
        12: {
            colors: ["33FF00", "FF0000", "FF0000", "33FF00"],
            text: "Get rekt m8"
        },
        13: {
            colors: ["FF7051", "6F391A"],
            text: "REKT"
        },
        14: {
